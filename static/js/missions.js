...
var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    ...
    function onMapClick(e) {
        ...
        if(isMarkerInsideHometownArea(markerPoint, area))
        {
            ...
            alert('Your selected Location is not in hometwon area. So you have to insert this mission into "Extra-Urban Mission".');
        }
    ...
    $(document).on("click", ".table .gn-icon-edit", function () {
        $('#CreateEditModal #gridSystemModalLabel').html("Edit Mission");
        var id = $(this).data('id');
    ...
    $(document).on("click", "#newMission", function () {
        $('#CreateEditModal #gridSystemModalLabel').html("New Mission");
